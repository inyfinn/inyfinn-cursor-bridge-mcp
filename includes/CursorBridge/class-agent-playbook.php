...
final class Agent_Playbook {
	...
	public static function instructions(): string {
		...
		$lines = array(
			...
			'Database: db-query is read-only; write `{prefix}` for the table prefix (e.g. SELECT ID FROM {prefix}posts). Files: read-/write-wp-content-file (paths relative to wp-content).',
