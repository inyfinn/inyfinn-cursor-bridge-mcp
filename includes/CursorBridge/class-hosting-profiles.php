	...
	public static function all(): array {
		return array(
			'seohost' => array(
				...
				'cursor_steps'  => array(
					'Zainstaluj i aktywuj **Inyfinn Cursor Bridge MCP** — auto-setup tworzy Application Password i cursor-setup.json.',
					'W Cursorze napisz: „uruchom wtyczkę inyfinn-cursor-bridge-mcp” — agent czyta wp-content/inyfinn-cursor-bridge/cursor-setup.json z workspace.',
					'Agent zapisuje .env i mcp.json; pyta tylko o brakujące pola (SSH, WORKSPACE_PUBLIC_HTML).',
					'Zamontuj public_html w Cursorze (SFTP/dysk S:) — warstwa plików; MCP — WordPress/DB/zapis plików.',
			...
			'generic' => array(
				...
				'cursor_steps' => array(
					'Aktywuj wtyczkę — auto-setup bez ręcznego Application Password.',
					'W Cursorze: „uruchom wtyczkę inyfinn-cursor-bridge-mcp”.',
					'Plik setup: wp-content/inyfinn-cursor-bridge/cursor-setup.json',
