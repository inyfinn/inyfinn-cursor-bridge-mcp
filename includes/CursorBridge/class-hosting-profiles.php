	...
	public static function all(): array {
		return array(
			'seohost' => array(
				...
				'cursor_steps'  => array(
					'Aktywuj wtyczkę — auto-setup tworzy Application Password i cursor-setup.json.',
					'W Cursorze: „uruchom wtyczkę inyfinn-cursor-bridge-mcp”.',
					'Jeden serwer MCP (wordpress-remote) daje: WordPress + bazę danych + pliki wp-content.',
					'Baza danych: cursor-bridge/db-query (wpdb na serwerze — bez zdalnego MySQL).',
			...
			'generic' => array(
				...
				'cursor_steps' => array(
					...
					'W Cursorze: „uruchom wtyczkę inyfinn-cursor-bridge-mcp”.',
					'Jeden MCP = WordPress + baza (db-query) + pliki (read/write-wp-content-file).',
					'Plik setup: wp-content/inyfinn-cursor-bridge/cursor-setup.json',
					'SSH opcjonalny dla WP-CLI.',
				),
				'wp_cli_hint' => 'wp',
